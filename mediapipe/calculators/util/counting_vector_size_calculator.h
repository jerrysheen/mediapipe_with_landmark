...
class CountingVectorSizeCalculator : public CalculatorBase { 
  public:
    static ::mediapipe::Status GetContract(CalculatorContract* cc) {
        // Check tag.
        // you can name whatever you want for this tag, this is just for convinience.
        // but remember it should be as same as the node code you add to your graph.
    ...
    ::mediapipe::Status Process(CalculatorContext* cc) {
        ...
        // continue to output something, so that the landmark graph/calculator then won't crush.
